    ...
    <div style="padding: 30px; width: 100%; min-height: 100%;">
        <div style="margin-bottom: 32px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                <div>
                    <h1 style="color: rgb(35, 35, 96); margin: 0px; font-size: 28px; font-weight: 700;">Roles &amp;
                        Permissions</h1>
                </div><button
                    style="background: rgb(100, 108, 255); color: white; border: none; border-radius: 8px; padding: 12px 24px; font-size: 14px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px; box-shadow: rgba(100, 108, 255, 0.25) 0px 2px 8px; transition: 0.2s;">
                    Add New</button>
            </div>
        </div>
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp.success) {
                            ...
                            showGlobalAlert(resp.message || 'Failed to delete role.');
                        }
                    },
                    error: function() {
                ...
                success: function(resp) {
                    if (resp.success) {
                        ...
                        if (newStatus) {
                            ...
                            toggle.next('span').css('color', 'rgb(46, 125, 50)').text('Active');
