...
try {
    ...
    $lowStockCount = Yii::$app->db->createCommand('SELECT COUNT(*) FROM stock WHERE status IN ("low_stock", "critical") AND is_deleted = 0')->queryScalar() ?: 0;

    // Expiring medicines (within 30 days)
    $expiringCount = Yii::$app->db->createCommand('SELECT COUNT(*) FROM stock WHERE expiry_date <= DATE_ADD(CURDATE(), INTERVAL 30 DAY) AND expiry_date > CURDATE() AND is_deleted = 0')->queryScalar() ?: 0;
    ...
    // Today's sales (mock data - replace with actual sales table when available)
    $todaySales = Yii::$app->db->createCommand('SELECT COALESCE(SUM(total_amount), 0) FROM purchase_orders WHERE DATE(created_at) = CURDATE() AND status = "delivered"')->queryScalar() ?: 0;
            ...
            <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
                <div style="margin-bottom: 18px; text-align: center;">
                    <div style="color: rgb(100, 108, 255); font-size: 17px; margin-top: 6px; font-weight: 500;">
                        Pharmacy Operations Dashboard</div>
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 18px;  justify-content: center; align-items: stretch;">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div style="text-align: left; font-size: 18px; font-weight: 800; margin-top: 2px;">
                                <?= number_format($totalMedicines) ?></div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <div style="text-align: left; font-size: 13px; opacity: 0.85; font-size: 11px;">Low Stock
                            </div>
                            <div
                    ...
                    <div
                        ...
                        <div>
                            <div style="text-align: left; font-size: 13px; opacity: 0.85; font-size: 11px;">Expiring
                                Soon</div>
                            <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <?= number_format($totalInventoryValue) ?></div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <div style="text-align: left; font-size: 13px; opacity: 0.85; font-size: 11px;">Today's
                                Sales</div>
                            <div
                                style="text-align: left; font-size: 18px; font-weight: 800; margin-top: 2px; color: rgb(59, 130, 246);">
                                <?= number_format($todaySales) ?></div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <div style="text-align: left; font-size: 13px; opacity: 0.85; font-size: 11px;">Suppliers
                            </div>
                            <div
